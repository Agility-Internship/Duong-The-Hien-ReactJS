    ...
    <div>
      ...
      <div className={`fixed w-full inset-0 z-50 ${isSliderBarOpen ? 'bg-black/30' : 'hidden'}`}>
        <SliderBar
          ...
          isFixed
          customSliderBarClassNames="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l border-neutral-200 bg-white/80 p-6 text-black backdrop-blur-xl dark:bg-white/60 dark:text-black md:w-[50%] lg:w-[35%] translate-x-0"
        >
